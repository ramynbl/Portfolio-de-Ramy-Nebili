...
export const skillsData = [
    ...
    { name: 'Blender', icon: SiBlender, color: '#F5792A', desc: 'Design 3D pour le web', status: 'Notions', category: 'Design System & UI' },
    ...
    { name: 'Three.js', icon: SiThreedotjs, color: '#000000', desc: 'Création de scène 3D', status: 'Utilisé en projet', category: 'Frontend Engineering' },
    ...
    { name: 'SQLite', icon: SiSqlite, color: '#003B57', desc: 'Base de données légère', status: 'Notions', category: 'Backend & Automation' },
    { name: 'MySQL', icon: SiMysql, color: '#4479A1', desc: 'Base de données SQL', status: 'Notions', category: 'Backend & Automation' },
    { name: 'Prisma', icon: SiPrisma, color: '#2D3748', desc: 'ORM pour Node.js et TypeScript', status: 'Utilisé en projet', category: 'Backend & Automation' },
    { name: 'Sanity', icon: SiSanity, color: '#F03E2F', desc: 'CMS moderne et flexible', status: 'Utilisé en projet', category: 'Backend & Automation' },

    // --- DATA & INFRASTRUCTURE ---
    { name: 'Jupyter', icon: SiJupyter, color: '#F37626', desc: 'Notebooks interactifs', status: 'Utilitaire', category: 'Data & Infrastructure' },
    { name: 'Pandas', icon: SiPandas, color: '#150458', desc: 'Analyse de données Python', status: 'Utilisé en projet', category: 'Data & Infrastructure' },
    { name: 'NumPy', icon: SiNumpy, color: '#013243', desc: 'Calcul scientifique', status: 'Utilisé en projet', category: 'Data & Infrastructure' },
    ...
    { name: 'Railway', icon: SiRailway, color: '#0B0D0E', desc: 'Infrastructure on rails', status: 'Favori', category: 'Data & Infrastructure' },
    { name: 'Docker', icon: SiDocker, color: '#2496ED', desc: 'Environnements de développement isolés', status: 'Utilisé en projet', category: 'Data & Infrastructure' },
    { name: 'Git', icon: SiGit, color: '#F05032', desc: 'Gestion de version', status: 'Utilisé en projet', category: 'Data & Infrastructure' },
];
